    ...
    private static String _doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout, Map<String, String> headerMap, boolean useHttpDns) throws IOException {
        ...
        try {
            ...
            try {
                ...
                GcloudLogger.logCommError(var18, url, (String)map.get("app_key"), (String)map.get("method"), content);
                throw var18;
            }
            ...
            try {
                ...
                map = getParamsFromUrl(url);
                GcloudLogger.logCommError(var17, conn, (String)map.get("app_key"), (String)map.get("method"), content);
                throw var17;
            }
        } finally {
            if(out != null) {
    ...
    private static String _doPostWithFile(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset, int connectTimeout, int readTimeout, Map<String, String> headerMap, boolean useHttpDns) throws IOException {
        ...
        try {
            ...
            try {
                ...
                map = getParamsFromUrl(url);
                GcloudLogger.logCommError(var24, url, (String)map.get("app_key"), (String)map.get("method"), params);
                throw var24;
            }
            ...
            try {
                ...
                map = getParamsFromUrl(url);
                GcloudLogger.logCommError(var25, conn, (String)map.get("app_key"), (String)map.get("method"), params);
                throw var25;
            }
        } finally {
            if(out != null) {
    ...
    public static String doGet(String url, Map<String, String> params, String charset, boolean useHttpDns) throws IOException {
        ...
        try {
            ...
            try {
                ...
                map = getParamsFromUrl(url);
                GcloudLogger.logCommError(var16, url, (String)map.get("app_key"), (String)map.get("method"), params);
                throw var16;
            }
            ...
            try {
                ...
                map = getParamsFromUrl(url);
                GcloudLogger.logCommError(var15, conn, (String)map.get("app_key"), (String)map.get("method"), params);
                throw var15;
            }
        } finally {
            if(conn != null) {
