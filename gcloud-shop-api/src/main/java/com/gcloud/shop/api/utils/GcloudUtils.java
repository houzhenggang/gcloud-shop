...
import com.gcloud.shop.api.utils.json.JSONWriter;
...
public class GcloudUtils {
    ...
    public static <T extends GcloudResponse> T parseResponse(String json, Class<T> clazz) throws GcloudException {
        ObjectJsonParser parser = new ObjectJsonParser(clazz);
        GcloudResponse rsp = parser.parse(json);
        rsp.setBody(json);
        return (T)rsp;
    }
