...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      ...
      <script src="<c:url value='/resources/js/angular2.dev.js' />" />
      <script src="<c:url value='/resources/js/system.js' />" />
      <script src="<c:url value='/resources/js/typescript.js' />" />
      ...
      <script src="<c:url value='/static/js/controller/user_controller.js' />" />
  </body>
</html>