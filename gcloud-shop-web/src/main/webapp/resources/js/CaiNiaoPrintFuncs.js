...
function returnCNHtml() {
    var _html = '<div style="padding: 10px;"><ul><li style="height: 30px;line-height: 30px;padding-bottom: 20px"><img width="33" src="/resources/css/build/images/icon_1.png"/>&nbsp;&nbsp;亲，您还未安装打印插件或安装版本过低，&nbsp;<a class="btn btn-primary" target="_blank" href="http://www.taobao.com/market/cainiao/eleprint.php">下载插件</a></li>' +
