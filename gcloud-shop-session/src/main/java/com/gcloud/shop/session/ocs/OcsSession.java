 ...
 *
 */
public class OcsSession extends AbstractRefSession {

	private static final Logger logger = LogManager.getLogger(OcsSession.class);
	 ...
	 * @throws Exception
	 */
	public OcsSession(HttpServletRequest req, HttpServletResponse rsp, String sessionId, Long storeId) throws Exception {
